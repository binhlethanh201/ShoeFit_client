  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const attrRes = await adminService.getAttributes({
          page: 1,
          size: 100,
        });
                ...
                <form onSubmit={handleSave} id="productForm">
                  <div className="row g-3">
                    ...
                    {!isEditMode && (
                      <div className="col-12">
                        <label className="form-label fw-bold small">
                          URL Ảnh phụ (Phân cách bằng dấu phẩy)
                        </label>
                        <textarea
                          className="form-control"
                          name="imagesInput"
                    ...
                    {isEditMode && (
                      <div className="col-12">
                        <div className="alert alert-info small m-0">
                          ...
                          Để chỉnh sửa Thuộc tính hoặc Ảnh phụ, vui lòng sử dụng
